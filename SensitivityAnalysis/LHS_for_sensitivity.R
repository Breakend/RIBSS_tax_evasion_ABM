...
model.parameters <- read.csv(paste(model.inputs.dir,"Sensitivity.Exp.Design.model.parameters",".csv",sep=""),
...
write.csv(cases,file=paste(model.inputs.dir,"lhs.cases_sensitivity",".csv",sep=""),row.names = FALSE)
